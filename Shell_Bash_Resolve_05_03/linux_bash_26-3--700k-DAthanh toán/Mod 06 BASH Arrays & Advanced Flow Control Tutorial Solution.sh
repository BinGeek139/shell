...
#Task 8 Get the name of a Marvel character from the user and pass it to the random insert function
echo -e "Task 8\n"
read -p "Please insert the name of a Marvel character: " userHero
...
intArray=($(for i in ${intArray[*]}; do echo $i; done  | sort -n ))
